...
export const NODES: CaveNode[] = [
  ...
  { id: 'gal-air1', pos: [-8, -12.5, -10], radius: 4, stretch: [1.5, 0.8, 1.4], dry: true, zone: 'galleries', tags: ['airPocket'] },
  ...
  { id: 'mz-air2', pos: [-6, -34.5, 30], radius: 4, stretch: [1.5, 0.8, 1.4], dry: true, zone: 'maze', tags: ['airPocket', 'ambushPocket'] },
  ...
  { id: 'throat-rim-air', pos: [5, -42, 40], radius: 4, stretch: [1.5, 0.8, 1.4], dry: true, zone: 'throat', tags: ['airPocket'] },
