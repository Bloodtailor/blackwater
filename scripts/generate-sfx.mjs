...
const SFX = {
  ...
  'amb-machinery': { p: 'One enormous slow industrial pump running behind a rock wall, CLEARLY AUDIBLE and strong: a deep powerful rhythmic WHOOM, WHOOM at about one stroke per second, low frequency but full and present, the mechanical heartbeat of a vast machine, hypnotic, steady, loud enough to feel, seamless loop with matching start and end. No clanking, no music.', sec: 10, loop: true },
