...
const SFX = {
  ...
  'ambient-deep': { p: 'Deep abyssal underwater ambience bed: a heavy continuous low rumble of immense water pressure, slow dark swells of current against rock, occasional distant muffled groans of stone settling, sub-bass weight, steady and continuous with no sudden events, no rhythm, no voices, designed to LOOP SEAMLESSLY with matching start and end, oppressive and vast. No music.', sec: 14, loop: true },
  // ── audio-emitter node palette (behind-the-walls life; user 2026-07-20) ──
  'amb-machinery': { p: 'A huge old industrial pump running steadily nearby: strong rhythmic mechanical strokes about once per second with an audible mid-frequency chug and hum, resonant metal body tone, continuous and loud, clearly audible on small speakers (not only sub-bass), steady hypnotic machine rhythm, seamless loop with matching start and end. No clanking accents, no music.', sec: 10, loop: true },
