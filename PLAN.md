...
- [ ] Dutch VO from LORE.md §2 line list (one consistent voice); surface-only trigger system + queued tape reactions + anti-spam (cooldown/priority/no-repeat per LORE.md §2.1)
...
- [ ] Boone's-letter intro card at run start (LORE.md §2.3 — this is the objective delivery; skippable)
