...
> **STATUS — NEXT UP: M3 (Player: swim, air, light).** Update this line every session.
...
- [ ] 6DOF swim per DESIGN §6.1 (water-momentum feel, sprint, camera-relative vertical, ambient wandering current) + surface walk on the platform
